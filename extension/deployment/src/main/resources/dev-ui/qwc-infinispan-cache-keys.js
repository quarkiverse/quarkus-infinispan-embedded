 ...
 */
export class QwcInfinispanCacheKeys extends LitElement {
    ...
    jsonRpc = new JsonRpc("io.quarkiverse.infinispan.quarkus-infinispan-embedded");
...
customElements.define('qwc-infinispan-cache-keys', QwcInfinispanCacheKeys);