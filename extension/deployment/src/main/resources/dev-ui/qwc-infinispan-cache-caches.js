...
import './qwc-infinispan-cache-keys.js';

export class QwcInfinispanCacheCaches extends LitElement {
    ...
    _renderCacheKeys(){
        return html`<qwc-infinispan-cache-keys
                        cacheName="${this._selectedCache.name}"
                        @cache-keys-back=${this._showCacheTable}></qwc-infinispan-cache-keys>`;
    }
...
customElements.define('qwc-infinispan-cache-caches', QwcInfinispanCacheCaches);
